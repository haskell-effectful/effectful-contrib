...
startProcess :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderr -> Eff es (PT.Process stdin stdout stderr)
...
withProcessWait :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderr -> (PT.Process stdin stdout stderr -> Eff es a) -> Eff es a
withProcessWait = liftWithProcess PT.withProcessWait

-- | Lifted 'PT.withProcessWait_'.
withProcessWait_ :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderr -> (PT.Process stdin stdout stderr -> Eff es a) -> Eff es a
withProcessWait_ = liftWithProcess PT.withProcessWait_

-- | Lifted 'PT.withProcessTerm'.
withProcessTerm :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderr -> (PT.Process stdin stdout stderr -> Eff es a) -> Eff es a
withProcessTerm = liftWithProcess PT.withProcessTerm

-- | Lifted 'PT.withProcessTerm_'.
withProcessTerm_ :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderr -> (PT.Process stdin stdout stderr -> Eff es a) -> Eff es a
withProcessTerm_ = liftWithProcess PT.withProcessTerm_

-- | Lifted 'PT.readProcess'.
readProcess :: TypedProcess :> es => PT.ProcessConfig stdin stdoutIgnored stderrIgnored -> Eff es (ExitCode, ByteString, ByteString)
readProcess = unsafeEff_ . PT.readProcess

-- | Lifted 'PT.readProcess_'.
readProcess_ :: TypedProcess :> es => PT.ProcessConfig stdin stdoutIgnored stderrIgnored -> Eff es (ByteString, ByteString)
readProcess_ = unsafeEff_ . PT.readProcess_

-- | Lifted 'PT.runProcess'.
runProcess :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderr -> Eff es ExitCode
runProcess = unsafeEff_ . PT.runProcess

-- | Lifted 'PT.runProcess_'.
runProcess_ :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderr -> Eff es ()
runProcess_ = unsafeEff_ . PT.runProcess_

-- | Lifted 'PT.runProcessStdout'.
runProcessStdout :: TypedProcess :> es => PT.ProcessConfig stdin stdoutIgnored stderr -> Eff es (ExitCode, ByteString)
runProcessStdout = unsafeEff_ . PT.readProcessStdout

-- | Lifted 'PT.runProcessStdout_'.
runProcessStdout_ :: TypedProcess :> es => PT.ProcessConfig stdin stdoutIgnored stderr -> Eff es ByteString
runProcessStdout_ = unsafeEff_ . PT.readProcessStdout_

-- | Lifted 'PT.runProcessStderr'.
runProcessStderr :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderrIgnored -> Eff es (ExitCode, ByteString)
runProcessStderr = unsafeEff_ . PT.readProcessStderr

-- | Lifted 'PT.runProcessStderr_'.
runProcessStderr_ :: TypedProcess :> es => PT.ProcessConfig stdin stdout stderrIgnored -> Eff es ByteString
runProcessStderr_ = unsafeEff_ . PT.readProcessStderr_

-- | Lifted 'PT.runProcessInterleaved'.
runProcessInterleaved :: TypedProcess :> es => PT.ProcessConfig stdin stdoutIgnored stderrIgnored -> Eff es (ExitCode, ByteString)
runProcessInterleaved = unsafeEff_ . PT.readProcessInterleaved

-- | Lifted 'PT.runProcessInterleaved_'.
runProcessInterleaved_ :: TypedProcess :> es => PT.ProcessConfig stdin stdoutIgnored stderrIgnored -> Eff es ByteString
...
liftWithProcess :: TypedProcess :> es => (PT.ProcessConfig stdin stdout stderr -> (PT.Process stdin stdout stderr -> IO a) -> IO a) -> PT.ProcessConfig stdin stdout stderr -> (PT.Process stdin stdout stderr -> Eff es a) -> Eff es a
